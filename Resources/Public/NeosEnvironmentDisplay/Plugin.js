...
/***/ "./src/Components/EnvironmentDisplay.css":
/*!***********************************************!*\
  !*** ./src/Components/EnvironmentDisplay.css ***!
  \***********************************************/
/*! no static exports found */
...
module.exports = {"wrapper":"EnvironmentDisplay__wrapper___3tV2b","content":"EnvironmentDisplay__content___1RKDr"};

/***/ }),

/***/ "./src/Components/EnvironmentDisplay.js":
/*!**********************************************!*\
  !*** ./src/Components/EnvironmentDisplay.js ***!
  \**********************************************/
/*! no static exports found */
...
exports.EnvironmentDisplay = undefined;
...
var _EnvironmentDisplay = __webpack_require__(/*! ./EnvironmentDisplay.css */ "./src/Components/EnvironmentDisplay.css");

var _EnvironmentDisplay2 = _interopRequireDefault(_EnvironmentDisplay);
...
var EnvironmentDisplay = exports.EnvironmentDisplay = (_dec = (0, _neosUiDecorators.neos)(function (globalRegistry) {
    return {
    ...
    _inherits(EnvironmentDisplay, _PureComponent);

    function EnvironmentDisplay() {
        _classCallCheck(this, EnvironmentDisplay);

        return _possibleConstructorReturn(this, (EnvironmentDisplay.__proto__ || Object.getPrototypeOf(EnvironmentDisplay)).apply(this, arguments));
    }

    _createClass(EnvironmentDisplay, [{
        key: 'render',
        value: function render() {
            var _props$displayConfigu = this.props.displayConfiguration,
                backgroundColor = _props$displayConfigu.backgroundColor,
                label = _props$displayConfigu.label,
                icon = _props$displayConfigu.icon;


            return label !== '' && _react2.default.createElement(
                'div',
                { className: _EnvironmentDisplay2.default.wrapper, style: { backgroundColor: backgroundColor } },
                icon ? _react2.default.createElement(_reactUiComponents.Icon, { icon: icon, padded: 'right' }) : '',
                _react2.default.createElement(
                    'span',
                    { className: _EnvironmentDisplay2.default.content },
                    label
                )
            );
        }
    ...
    displayConfiguration: _propTypes2.default.object
}, _temp)) || _class);
...
var _EnvironmentDisplay = __webpack_require__(/*! ./Components/EnvironmentDisplay */ "./src/Components/EnvironmentDisplay.js");
...
(0, _neosUiExtensibility2.default)('PunktDe.EditConflictPrevention:HighlightNonEditablePage', {}, function (globalRegistry) {
    ...
    containerRegistry.set('PrimaryToolbar/Left/PunktDe.NeosEnvironmentDisplay.CurrentEnvironment', _EnvironmentDisplay.EnvironmentDisplay);
});
